...
@section('content')
    <div class="page-content">
        ...
        @include('layouts.partials.pagetitle', [
            ...
            'subtitle' => 'Berita',
            'title' => 'Kategori',
            'action' => request()->is('news/news-categories')
                ? [
                    'label' => 'Tambah Kategori',
                    'url' => route('news-categories.create'),
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex gap-1">
                                                        {{-- EDIT --}}
                                                        <a href="{{ route('news-categories.edit', $p->id) }}"
                                                            class="btn btn-outline-secondary btn-sm" title="Edit">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>

                                                        {{-- DELETE --}}
                                                        <form action="{{ route('news-categories.destroy', $p->id) }}"
