...
@section('content')
    <div class="page-content">
        ...
        @include('layouts.partials.pagetitle', [
            ...
            'subtitle' => 'Lokasi TUK',
            'title' => 'TUK',
            'action' => request()->is('tuks')
                ? [
                    'label' => 'Tambah TUK',
                    'url' => route('tuks.create'),
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered datatable datatable-buttons">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex gap-1">
                                                        {{-- EDIT --}}
                                                        <a href="{{ route('tuks.edit', $p->id) }}"
                                                            class="btn btn-outline-secondary btn-sm" title="Edit">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>

                                                        {{-- DELETE --}}
                                                        <form action="{{ route('tuks.destroy', $p->id) }}" method="POST"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center">Tidak ada Lokasi TUK</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
