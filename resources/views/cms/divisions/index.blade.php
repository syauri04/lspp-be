...
@section('content')
    <div class="page-content">
        ...
        @include('layouts.partials.pagetitle', [
            ...
            'title' => 'Divisi',
            'action' => request()->is('organizational/divisions')
                ? [
                    'label' => 'Tambah Divisi',
                    'url' => route('divisions.create'),
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered datatable datatable-buttons">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex gap-1">
                                                        {{-- EDIT --}}
                                                        <a href="{{ route('divisions.edit', $p->id) }}"
                                                            class="btn btn-outline-secondary btn-sm" title="Edit">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>

                                                        {{-- DELETE --}}
                                                        <form action="{{ route('divisions.destroy', $p->id) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center">Tidak ada divisi</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
