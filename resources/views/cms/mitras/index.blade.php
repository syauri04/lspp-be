...
@section('content')
    <div class="page-content">
        ...
        @include('layouts.partials.pagetitle', [
            ...
            'subtitle' => 'Mitra',
            'title' => 'List Mitra',
            'action' => request()->is('mitras')
                ? [
                    'label' => 'Tambah Mitra',
                    'url' => route('mitras.create'),
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered datatable datatable-buttons">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($mitras as $index => $p)
                                            <tr>
                                                ...
                                                <td width="120">
                                                    ...
                                                    @if ($p->logo)
                                                        <img src="{{ asset($p->logo) }}" width="100">
                                                    @endif
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex gap-1">
                                                        {{-- EDIT --}}
                                                        <a href="{{ route('mitras.edit', $p->id) }}"
                                                            class="btn btn-outline-secondary btn-sm" title="Edit">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>

                                                        {{-- DELETE --}}
                                                        <form action="{{ route('mitras.destroy', $p->id) }}" method="POST"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="text-center">Tidak ada Mitra</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
